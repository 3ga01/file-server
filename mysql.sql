...
--
-- Host: localhost
-- Generation Time: Mar 26, 2023 at 07:37 PM
...
(1, 'trigger@email.com', 'trigger', 'newAdmin');
...
('mysql', 'USER', 'PRIMARY', '2023-03-21 02:38:30', 'n_diff_pfx01', 2, 1, 'ID'),
('mysql', 'USER', 'PRIMARY', '2023-03-21 02:38:30', 'n_leaf_pages', 1, NULL, 'Number of leaf pages in the index'),
('mysql', 'USER', 'PRIMARY', '2023-03-21 02:38:30', 'size', 1, NULL, 'Number of pages in the index'),
('mysql', 'admin', 'PRIMARY', '2023-03-26 11:13:04', 'n_diff_pfx01', 0, 1, 'id'),
('mysql', 'admin', 'PRIMARY', '2023-03-26 11:13:04', 'n_leaf_pages', 1, NULL, 'Number of leaf pages in the index'),
('mysql', 'admin', 'PRIMARY', '2023-03-26 11:13:04', 'size', 1, NULL, 'Number of pages in the index'),
('mysql', 'admin_seq', 'GEN_CLUST_INDEX', '2023-03-26 17:03:36', 'n_diff_pfx01', 21, 1, 'DB_ROW_ID'),
('mysql', 'admin_seq', 'GEN_CLUST_INDEX', '2023-03-26 17:03:36', 'n_leaf_pages', 1, NULL, 'Number of leaf pages in the index'),
('mysql', 'admin_seq', 'GEN_CLUST_INDEX', '2023-03-26 17:03:36', 'size', 1, NULL, 'Number of pages in the index'),
...
('mysql', 'member', 'PRIMARY', '2023-03-26 13:47:25', 'n_diff_pfx01', 7, 1, 'id'),
('mysql', 'member', 'PRIMARY', '2023-03-26 13:47:25', 'n_leaf_pages', 1, NULL, 'Number of leaf pages in the index'),
('mysql', 'member', 'PRIMARY', '2023-03-26 13:47:25', 'size', 1, NULL, 'Number of pages in the index'),
('mysql', 'member', 'UK_9esvgikrmti1v7ci6v453imdc', '2023-03-26 13:47:25', 'n_diff_pfx01', 7, 1, 'name'),
('mysql', 'member', 'UK_9esvgikrmti1v7ci6v453imdc', '2023-03-26 13:47:25', 'n_leaf_pages', 1, NULL, 'Number of leaf pages in the index'),
('mysql', 'member', 'UK_9esvgikrmti1v7ci6v453imdc', '2023-03-26 13:47:25', 'size', 1, NULL, 'Number of pages in the index'),
('mysql', 'member', 'email', '2023-03-26 13:47:25', 'n_diff_pfx01', 7, 1, 'email'),
('mysql', 'member', 'email', '2023-03-26 13:47:25', 'n_leaf_pages', 1, NULL, 'Number of leaf pages in the index'),
('mysql', 'member', 'email', '2023-03-26 13:47:25', 'size', 1, NULL, 'Number of pages in the index'),
('mysql', 'member', 'email_2', '2023-03-26 13:47:25', 'n_diff_pfx01', 7, 1, 'email'),
('mysql', 'member', 'email_2', '2023-03-26 13:47:25', 'n_leaf_pages', 1, NULL, 'Number of leaf pages in the index'),
('mysql', 'member', 'email_2', '2023-03-26 13:47:25', 'size', 1, NULL, 'Number of pages in the index'),
('mysql', 'member', 'email_3', '2023-03-26 13:47:25', 'n_diff_pfx01', 7, 1, 'email'),
('mysql', 'member', 'email_3', '2023-03-26 13:47:25', 'n_leaf_pages', 1, NULL, 'Number of leaf pages in the index'),
('mysql', 'member', 'email_3', '2023-03-26 13:47:25', 'size', 1, NULL, 'Number of pages in the index'),
('mysql', 'member', 'id', '2023-03-26 13:47:25', 'n_diff_pfx01', 7, 1, 'id'),
('mysql', 'member', 'id', '2023-03-26 13:47:25', 'n_leaf_pages', 1, NULL, 'Number of leaf pages in the index'),
('mysql', 'member', 'id', '2023-03-26 13:47:25', 'size', 1, NULL, 'Number of pages in the index'),
('mysql', 'member', 'name', '2023-03-26 13:47:25', 'n_diff_pfx01', 7, 1, 'name'),
('mysql', 'member', 'name', '2023-03-26 13:47:25', 'n_leaf_pages', 1, NULL, 'Number of leaf pages in the index'),
('mysql', 'member', 'name', '2023-03-26 13:47:25', 'size', 1, NULL, 'Number of pages in the index'),
('mysql', 'member_seq', 'GEN_CLUST_INDEX', '2023-03-26 15:50:00', 'n_diff_pfx01', 165, 1, 'DB_ROW_ID'),
('mysql', 'member_seq', 'GEN_CLUST_INDEX', '2023-03-26 15:50:00', 'n_leaf_pages', 1, NULL, 'Number of leaf pages in the index'),
('mysql', 'member_seq', 'GEN_CLUST_INDEX', '2023-03-26 15:50:00', 'size', 1, NULL, 'Number of pages in the index'),
('mysql', 'user_seq', 'GEN_CLUST_INDEX', '2023-03-21 03:13:45', 'n_diff_pfx01', 4, 1, 'DB_ROW_ID'),
('mysql', 'user_seq', 'GEN_CLUST_INDEX', '2023-03-21 03:13:45', 'n_leaf_pages', 1, NULL, 'Number of leaf pages in the index'),
('mysql', 'user_seq', 'GEN_CLUST_INDEX', '2023-03-21 03:13:45', 'size', 1, NULL, 'Number of pages in the index'),
...
('mysql', 'USER', '2023-03-21 02:38:30', 2, 1, 0),
('mysql', 'admin', '2023-03-26 11:13:04', 0, 1, 0),
('mysql', 'admin_seq', '2023-03-26 17:03:36', 21, 1, 0),
('mysql', 'gtid_slave_pos', '2015-11-24 22:42:49', 0, 1, 0),
('mysql', 'member', '2023-03-26 13:47:25', 7, 1, 6),
('mysql', 'member_seq', '2023-03-26 15:50:00', 165, 1, 0),
('mysql', 'user_seq', '2023-03-21 03:13:45', 4, 1, 0),
...
(1402, 'trigger@email.com', 'trigger', 'admin'),
(1452, 'abena@email.com', 'abena', 'admin'),
(1502, 'esther@gmail.com', 'esther', 'admin'),
(1554, 'trigger1@email.com', 'trigger1', 'admin'),
(1602, 'emmanuel@email.com', 'emmanuel', 'password'),
(1802, 'gladys@email.com', 'gladys', 'newAdmin'),
(1852, 'jerry@email.com', 'jerry', 'user');
...
(1, 'emmanuel', 'emmanuel@email.com', 'admin'),
(2, 'esther', 'esther@gmail.com', 'admin');
...
('localhost', 'trigger', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, 'mysql_native_password', '*75B62A5A340E6A1F085FF3A2F78BE59980E97B72', 'N', 'N', '', '0.000000'),
...
ALTER TABLE `member`
  ...
  ADD UNIQUE KEY `name` (`name`),
  ADD UNIQUE KEY `UK_9esvgikrmti1v7ci6v453imdc` (`name`),
